...
sh 'scp  /home/ubuntu/jenkins/workspace/APIGateway/API/docker-compose-API.yml ubuntu@129.114.104.73:/tmp'
sh 'ssh ubuntu@129.114.104.73 sudo docker stack deploy -c /tmp/docker-compose-API.yml APIgateway'
